-- Installed as whole statements by ensureDatabase before serving any Portal API.
-- Hosted migration import does not accept trigger bodies split at semicolons.
